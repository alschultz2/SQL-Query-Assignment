...
$query = 'SELECT E.firstName, E.lastName, E.emailAddress, E.phone, T.city, T.line1, T.state, T.zipCode, T.customerID FROM customers E
INNER JOIN addresses T
ON E.customerID = T.customerID
GROUP BY E.customerID, E.emailAddress, E.firstName, E.lastName, T.line1, T.city, T.state, T.zipCode, E.phone
ORDER BY T.customerID ASC';// PUT YOUR SQL QUERY HERE
